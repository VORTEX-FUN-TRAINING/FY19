...
仕組み
==
- テキストファイル(HarukasQuotes.txt)に言い間違いを用意
  - 1行１言い間違いです
- quote_provider_by_file.pyで言い間違いを読み込んでいる
  - get_quote()メソッドを実行すると、言い間違いナンバーと
  - 言い間違いの内容と番号をリストで返してくれる
- tocaro_handler.pyが、tocaroにメッセージを投げてくれる
  - 
- main.pyで、言い間違い
...
- 私が勉強会を開催した意味がなくなる。私の半年間を返してほしい 

---

低難易度：片方向＆webAPIあり＆lambdaなし版
==
- tocaroに一方的にメッセージを送付するボットです
- 投稿情報の管理にwebAPIを使います
- 自動でのメッセージ投稿は、ダッサいcronを使います
### メリット
- 新しく覚えるのはRESTやwebAPI作成の知識のみ
### デメリット
- cronというダサい仕組みを使うことになるので、EC2インスタンス代が余分にかかる。誰が払ってると思ってるんだ！ヽ(`Д´)ﾉﾌﾟﾝﾌﾟﾝ

---

中難易度：片方向＆webAPIあり＆lambdaあり版
==
- tocaroに一方的にメッセージを送付するボットです
