...
- ちなみにselfは習慣的にselfが使われているだけで、hogeでもmogeでも動作は変わらない
...
Pythonモジュールの作成方法
==
- 関数でもクラスでもいいので、処理のブロックを書いてファイルにする
- 例えば、sumnum.py
```
def sumnum(a,b):
    return a+b
